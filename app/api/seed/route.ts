...
const DEMO: DemoConv[] = [
  {
    ...
    appointmentData: { name: "Priya Sharma", concern: "Severe back pain", phone: "919876543210", confirmedDatetime: "Wednesday, 28 May at 11:00 AM" },
    messages: [
  ...
  },
  {
    ...
    appointmentData: { name: "Rahul Verma", concern: "Fever and cough for 4 days", phone: "9811223344", confirmedDatetime: "Thursday, 29 May at 2:00 PM" },
    messages: [
  ...
  },
  {
    ...
    appointmentData: { name: "Suresh Patel", concern: "Diabetes checkup", phone: "919777888999" },
    messages: [
  ...
  },
  {
    ...
    appointmentData: { name: "Kiran Mehta", concern: "Skin allergy and rash", phone: "9555444333", confirmedDatetime: "Friday, 30 May at 10:00 AM" },
    messages: [
